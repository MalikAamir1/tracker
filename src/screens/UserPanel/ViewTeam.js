...
import {ButtonViewAllTeam, CustomButton} from '../../Components/Custombtn';
import BottomTabNavigation from '../../Navigation/BottomTabNavigation';
import {PopInput} from '../../Components/CustomInput';
...
const ViewTeam = ({navigation}) => {
  ...
  const renderTeamItem = ({item}) => (
    <View style={styles.teamContainer}>
      <TouchableOpacity onPress={() => navigation.navigate('TeamDetail')}>
